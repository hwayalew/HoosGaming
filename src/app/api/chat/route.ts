...
• Load Three.js from: https://cdnjs.cloudflare.com/ajax/libs/three.js/r134/three.min.js (blocking <script src>)
• html,body { width:100%; height:100%; margin:0; overflow:hidden }
...
ABSOLUTE RULES:
• Wrap in \`\`\`html ... \`\`\`
• Load Babylon.js from: https://cdn.babylonjs.com/babylon.js (blocking <script src>)
• html,body { width:100%; height:100%; margin:0; overflow:hidden }
...
ABSOLUTE RULES:
• Wrap in \`\`\`html ... \`\`\`
• Load p5.js from: https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.9.0/p5.min.js (blocking <script src>)
• html,body { width:100%; height:100%; margin:0; overflow:hidden }
• Web Audio API sounds; NEVER truncate
...
ABSOLUTE RULES:
• Wrap in \`\`\`html ... \`\`\`
• Load Kaboom from: https://unpkg.com/kaboom@3000.0.1/dist/kaboom.js (blocking <script src>)
• html,body { width:100%; height:100%; margin:0; overflow:hidden }
• Web Audio API sounds; NEVER truncate
...
ABSOLUTE RULES:
• Wrap in \`\`\`html ... \`\`\`
• Load PixiJS from: https://cdnjs.cloudflare.com/ajax/libs/pixi.js/7.2.4/pixi.min.js (blocking <script src>)
• html,body { width:100%; height:100%; margin:0; overflow:hidden }
• Web Audio API sounds; NEVER truncate
