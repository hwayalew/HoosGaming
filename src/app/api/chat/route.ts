...
Wrap in \`\`\`html ... \`\`\`. Load Three.js from: https://cdnjs.cloudflare.com/ajax/libs/three.js/r134/three.min.js (blocking <script src>)
...
Wrap in \`\`\`html ... \`\`\`. Load Babylon from: https://cdn.babylonjs.com/babylon.js (blocking <script src>)
html,body{width:100%;height:100%;margin:0;overflow:hidden} Web Audio API. NEVER truncate.
...
Wrap in \`\`\`html ... \`\`\`. Load Kaboom from: https://unpkg.com/kaboom@3000.0.1/dist/kaboom.js (blocking <script src>)
html,body{width:100%;height:100%;margin:0;overflow:hidden} Web Audio API. NEVER truncate.
